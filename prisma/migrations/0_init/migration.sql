...
CREATE TABLE "tenant" (
    ...
    CONSTRAINT "idx_21630_sqlite_autoindex_tenant_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "user" (
    ...
    CONSTRAINT "idx_21477_sqlite_autoindex_user_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "team" (
    ...
    CONSTRAINT "idx_21492_sqlite_autoindex_team_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "team_member" (
    ...
    CONSTRAINT "idx_21517_sqlite_autoindex_team_member_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "environment" (
    ...
    CONSTRAINT "idx_21567_sqlite_autoindex_environment_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "application" (
    ...
    CONSTRAINT "idx_21498_sqlite_autoindex_application_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "api_key" (
    ...
    CONSTRAINT "idx_21485_sqlite_autoindex_api_key_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "api_function" (
    ...
    CONSTRAINT "idx_21523_sqlite_autoindex_api_function_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "custom_function" (
    ...
    CONSTRAINT "idx_21573_sqlite_autoindex_custom_function_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "auth_provider" (
    ...
    CONSTRAINT "idx_21532_sqlite_autoindex_auth_provider_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "webhook_handle" (
    ...
    CONSTRAINT "idx_21542_sqlite_autoindex_webhook_handle_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "conversation" (
    ...
    CONSTRAINT "idx_21611_sqlite_autoindex_conversation_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "conversation_message" (
    ...
    CONSTRAINT "idx_21656_sqlite_autoindex_conversation_message_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "system_prompt" (
    ...
    CONSTRAINT "idx_21511_sqlite_autoindex_system_prompt_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "auth_token" (
    ...
    CONSTRAINT "idx_21505_sqlite_autoindex_auth_token_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "config_variable" (
    ...
    CONSTRAINT "idx_21551_config_variable_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "gpt_plugin" (
    ...
    CONSTRAINT "idx_21591_gpt_plugin_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "variable" (
    ...
    CONSTRAINT "idx_21558_sqlite_autoindex_variable_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "migration" (
    ...
    CONSTRAINT "idx_21584_sqlite_autoindex_migration_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "limit_tier" (
    ...
    CONSTRAINT "idx_21624_sqlite_autoindex_limit_tier_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "statistics" (
    ...
    CONSTRAINT "idx_21618_sqlite_autoindex_statistics_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "docsection" (
    ...
    CONSTRAINT "idx_21603_sqlite_autoindex_docsection_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "tenant_agreement" (
    ...
    CONSTRAINT "idx_21649_sqlite_autoindex_tenant_agreement_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "tenant_sign_up" (
    ...
    CONSTRAINT "idx_21637_sqlite_autoindex_tenant_sign_up_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "tos" (
    ...
    CONSTRAINT "idx_21643_sqlite_autoindex_tos_1" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "idx_21630_tenant_name_key" ON "tenant"("name");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21477_user_email_key" ON "user"("email");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21567_environment_subdomain_key" ON "environment"("subdomain");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21485_api_key_key_key" ON "api_key"("key");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21591_gpt_plugin_slug_environment_id_key" ON "gpt_plugin"("slug", "environment_id");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21637_tenant_sign_up_email_key" ON "tenant_sign_up"("email");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21637_tenant_sign_up_name_key" ON "tenant_sign_up"("name");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21637_tenant_sign_up_verification_code_key" ON "tenant_sign_up"("verification_code");

-- CreateIndex
CREATE UNIQUE INDEX "idx_21643_tos_version_key" ON "tos"("version");
