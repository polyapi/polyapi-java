...
CREATE TABLE "tenant" (
    ...
    CONSTRAINT "idx_24356_sqlite_autoindex_tenant_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "api_key" (
    ...
    CONSTRAINT "idx_24211_sqlite_autoindex_api_key_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "api_function" (
    ...
    CONSTRAINT "idx_24249_sqlite_autoindex_api_function_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "auth_token" (
    ...
    CONSTRAINT "idx_24231_sqlite_autoindex_auth_token_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "config_variable" (
    ...
    CONSTRAINT "idx_24277_config_variable_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "limit_tier" (
    ...
    CONSTRAINT "idx_24350_sqlite_autoindex_limit_tier_1" PRIMARY KEY ("id")
);
...
CREATE TABLE "statistics" (
    ...
    CONSTRAINT "idx_24344_sqlite_autoindex_statistics_1" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "idx_24356_tenant_name_key" ON "tenant"("name");

-- CreateIndex
CREATE UNIQUE INDEX "idx_24203_user_email_key" ON "users"("email");

-- CreateIndex
CREATE UNIQUE INDEX "idx_24293_environment_subdomain_key" ON "environment"("subdomain");
...
-- CreateIndex
CREATE UNIQUE INDEX "idx_24363_tenant_sign_up_email_key" ON "tenant_sign_up"("email");

-- CreateIndex
CREATE UNIQUE INDEX "idx_24363_tenant_sign_up_verification_code_key" ON "tenant_sign_up"("verification_code");

-- CreateIndex
CREATE UNIQUE INDEX "idx_24369_tos_version_key" ON "tos"("version");
