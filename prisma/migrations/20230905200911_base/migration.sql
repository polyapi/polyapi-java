/*
  ...
  - Made the column `user_id` on table `conversation_message` required. This step will fail if there are existing NULL values in that column.
  ...
  - Made the column `user_id` on table `statistics` required. This step will fail if there are existing NULL values in that column.
